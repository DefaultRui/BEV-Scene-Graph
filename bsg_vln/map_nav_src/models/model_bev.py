...
from .vlnbert_bev_init import get_vlnbert_models
...
class VLNBert(nn.Module):
    ...
    def forward(self, mode, batch):
        ...
        if mode == 'language':            
            ...
            bev_embeds, candi_bev, candi_id, finebevembs, bevpoints, candi2bev_tmp = self.vln_bert(mode, batch)
            return bev_embeds, candi_bev, candi_id, finebevembs, bevpoints, candi2bev_tmp

        elif mode == 'bev_fts':
            bevvp_embeds, bevvp_masks = self.vln_bert(mode, batch)
