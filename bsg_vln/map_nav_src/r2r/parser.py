...
def parse_args():
    ...
    # for bev
    parser.add_argument('--bevglobal', action='store_true', default=False, help="use bev global branch")

    parser.add_argument('--bev_range', type=float, default=5.0, help="[-10, 10] actually *2")
    parser.add_argument('--bev_height', type=float, default=3.0)
    parser.add_argument('--bev_grid', type=int, default=11, help="20*20 grids")
    parser.add_argument('--bev_locals', type=int, default=9, help="use how many grids to do bev local decision")
    
    parser.add_argument("--bev_ckpt_file", default=None, help='path of the trained bev model')
    parser.add_argument('--bevlocalsall', action='store_true', default=False, help="use all bev local grids")
    parser.add_argument("--bevfeaturepath", default=None, help='path of the trained bev 3D object detection model')
    parser.add_argument('--bev_candinum', type=int, default=9, help="closest grids for candi")
    parser.add_argument('--candi2bev_dir', type=str, default='/candi2bev')
    
    #for bevnew for simplicity
    parser.add_argument('--onlybev', action='store_true', default=False, help="only use bev branch")
    parser.add_argument('--bev_weight', type=float, default=0.50, help="bev branch weight")
    parser.add_argument('--candi2bevfts', type=str, default=None)
